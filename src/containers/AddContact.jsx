	...
	render() {
		return(
			<div>
				...
				{ this.state.isHidden === false ? this.renderForm(): <button onClick={this.showAddContactBox} className="btn">Add <i class="fa fa-address-card-o" aria-hidden="true"></i> </button>}
			</div>
			)
	}
}